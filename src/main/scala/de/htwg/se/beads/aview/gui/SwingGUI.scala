...
class SwingGUI(controller: ControllerInterface) extends Frame {
  ...
  title = "HTWG Sudoku"
  var cells: Array[Array[BeadPanel]] = Array.ofDim[BeadPanel](controller.tempLength, controller.tempWidth)

  def gridPanel1: GridPanel = new GridPanel(controller.tempLength, controller.tempWidth) {
  ...
  menuBar = new MenuBar {
    ...
    contents += new Menu("Edit") {
      ...
      contents += new MenuItem(Action("new Square Template 10x10"){TemplateDialog(Stitch.Square)})
    }
  }
