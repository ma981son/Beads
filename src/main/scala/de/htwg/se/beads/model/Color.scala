...
import de.htwg.se.beads.model

import scala.collection.immutable.Map
import io.AnsiColor._

object stringToAnsi{
  val colors = Map("black" -> BLACK_B, "red" -> RED_B, "green" -> GREEN_B,
    "yellow" -> YELLOW_B, "blue" -> BLUE_B, "magenta" -> MAGENTA_B, "cyan" -> CYAN_B,
    "white" -> WHITE_B)
}

object rgbToAnsi{
  val colors = Map(Color(0,0,0) -> BLACK_B, Color(255,0,0) -> RED_B, Color(0,255,0) -> GREEN_B,
